...
int main()
{
	...
	/*Indices secundário nome (iDriver)*/

	/*Indices secundário data (iDate)*/
	
	/*Indices secundário hora (iTime)*/

	/*Indices secundário rota (iRoute)*/
...
void gerarChave(Carona *novo){
	...
	chave[0] = toupper(novo->nome[0]);
	chave[1] = toupper(novo->placa[0]);
	chave[2] = toupper(novo->placa[1]);
	chave[3] = toupper(novo->placa[2]);
	chave[4] = novo->data[0];
	chave[5] = novo->data[1];
	chave[6] = novo->data[3];
	chave[7] = novo->data[4];
